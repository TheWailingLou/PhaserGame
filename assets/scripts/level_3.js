...
level_3.prototype = {
  create: function() {
    ...
    mapColor = game.add.tilemap('L3map', 32, 32);
    mapBW = game.add.tilemap('L3map', 32, 32)
    ...
    protagColor = game.add.sprite(1312, 800, 'protagColor');
    protagBW = game.add.sprite(1312, 800, 'protagBW');

    protagRed = game.add.sprite(1312, 800, 'protagBW');
    protagBlue = game.add.sprite(1312, 800, 'protagBW');
    protagGreen = game.add.sprite(1312, 800, 'protagBW');

    bluePower1 = game.add.sprite(1568, 864, 'bluePower');
    bluePower2 = game.add.sprite(1664, 320, 'bluePower');
    bluePower3 = game.add.sprite(1472, 320, 'bluePower');
    greenPower1 = game.add.sprite(1568, 736, 'greenPower');
    greenPower2 = game.add.sprite(1440, 320, 'greenPower');
    greenPower3 = game.add.sprite(1600, 448, 'greenPower');
    redPower1 = game.add.sprite(1440, 800, 'redPower');
    redPower2 = game.add.sprite(1696, 320, 'redPower');
    redPower3 = game.add.sprite(1536, 448, 'redPower');

    wallRight1 = game.add.sprite(1280, 1824, 'wallRight');
    wallRight2 = game.add.sprite(1280, 1792, 'wallRight');
    wallRight3 = game.add.sprite(1280, 1760, 'wallRight');
    ...
    bluePower = [bluePower1, bluePower2, bluePower3]
    greenPower = [greenPower1, greenPower2, greenPower3]
    redPower = [redPower1, redPower2, redPower3]
    orbs = [bluePower1, bluePower2, bluePower3, greenPower1, greenPower2, greenPower3, redPower1, redPower2, redPower3]
